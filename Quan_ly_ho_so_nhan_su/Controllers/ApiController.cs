	...
	public class ApiController : Controller
	{
		...
		public IActionResult GetChiNhanhListByNganHangId(int id)
		{
			...
			var chiNhanhList = _unitOfWork.ChiNhanhNganHangTable.GetAll(cn => cn.NganHangId == id)
				.Select(c => new 
				{ 
					c.Id, Name = UtilClass.GetNameByTypeAndId(typeof(XaPhuong), _unitOfWork.ChiNhanhNganHangTable.Get(u => u.Id == c.Id, includeProperties: "DiaChi").DiaChi.XaPhuongId, _unitOfWork) 
				})
				.ToList();
