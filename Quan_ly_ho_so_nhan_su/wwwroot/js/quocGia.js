            ...
            },
            {
                ...
                "render": function (data, type, row) {
                    return `<div class="w-100 btn-group ms-auto btn-group-equal" role="group">
                                <a href="/Admin/QuocGia/Upsert?id=${data}" class="btn btn-primary mx-2"><i class="bi bi-pencil-square"></i> Sửa</a>
                                <a onClick="Delete('/Admin/QuocGia/Delete/${data}')" class="btn btn-danger mx-2"><i class="bi bi-trash-fill"></i> Xóa</a>
...
function Delete(url) {
    Swal.fire({
        title: "Bạn chắc chứ?",
        text: "Quốc gia sẽ bị xóa vĩnh viễn!",
        icon: "warning",
...
function ToggleApply(id, isApplied) {
    Swal.fire({
        ...
        text: isApplied ? "Quốc gia sẽ ngừng áp dụng." : "Quốc gia sẽ được áp dụng.",
        icon: "warning",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        cancelButtonColor: "#d33",
